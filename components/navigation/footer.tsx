    ...
    <footer className="flex flex-col relative items-center justify-center border-t border-border pt-16 lg:pt-32 pb-8 px-6 lg:px-8 w-full max-w-6xl mx-auto">
      ...
      <div className="grid gap-8 xl:grid-cols-3 xl:gap-8 w-full">
        <div className="flex flex-col items-start justify-start md:max-w-[200px]">
          ...
          <p className="text-muted-foreground mt-4 text-sm text-start">
            Engage your customers today with convoai.
          </p>
        ...
        <div className="grid sm:grid-cols-4 grid-cols-2 gap-8 mt-16 xl:col-span-2 xl:mt-0">
      ...
      <div className="mt-8 border-t border-border/40 pt-4 md:pt-8 md:flex md:items-center md:justify-between w-full">
        <p className="text-sm text-muted-foreground mt-8 md:mt-0">
          &copy; {new Date().getFullYear()} convoai Technologies Inc. All rights
          reserved
        </p>
      </div>
    </footer>
